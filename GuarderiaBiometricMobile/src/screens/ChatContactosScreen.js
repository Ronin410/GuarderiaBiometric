...
export default function ChatContactosScreen({ navigation }) {
  ...
  return (
    <FlatList
      ...
      ListHeaderComponent={<Text style={styles.encabezado}>¿Con quién quieres hablar?</Text>}
      renderItem={({ item: ct }) => (
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  encabezado: { fontSize: 12, fontWeight: '700', color: color.slate400, marginBottom: 4 },
  tarjeta: {
