  ...
  return (
    <div className="fixed inset-0 z-[250] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm">
      <div className="bg-white w-full max-w-lg rounded-[2rem] shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
        ...
        {pdfUrl ? (
          // La guardería subió el aviso como PDF en vez de escribirlo -- se
          // muestra en línea (los navegadores renderizan PDF nativo en un
          // iframe) para no obligar a descargarlo antes de poder leerlo.
          <iframe src={pdfUrl} title="Aviso de Privacidad" className="flex-1 w-full border-0 bg-slate-50" style={{ minHeight: '50vh' }} />
        ) : (
