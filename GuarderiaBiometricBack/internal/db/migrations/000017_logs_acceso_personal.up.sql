-- Amplía el catálogo de eventos auditables de logs_acceso para cubrir la
-- gestión de personal (crear cuenta, editar, cambiar PIN, resetear
-- contraseña) — acciones sensibles porque tocan quién puede entrar al
-- sistema y con qué PIN administrativo.
